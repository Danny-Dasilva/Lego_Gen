...
const main = async () => {
  ...
  const element_is_visible = await page.$eval('#gallery', (elem) => {
    ...
    console.log("Proceding to try logging in");  // Prints "Error: something went terribly wrong"
  });
  ...
  console.log(names);
  const fs = require("fs");
  fs.writeFile("./my-downloads/labels_1000.json", JSON.stringify(names), (err) =>
  ...
  fs.rename('./my-downloads/Untitled\ Model.zmbx', `./my-downloads/1000_most_common.zmbx`, () => {
    console.log("\nFile Renamed!\n");
